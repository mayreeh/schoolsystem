                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-hover" id="sample-table-2">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $i = 1;
                                                    foreach ($this->load->main_model->getStudents() as $students) {
                                                        ?>
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <?php
                                                                $studentClass = $this->load->main_model->getSchoolClassById($students['class_id']);
                                                                if (!empty($studentClass)) {
                                                                    echo $studentClass[0]['classname'];
                                                                } else {
                                                            ...
                                                            <td  class="center">
                                                                <div class="visible-md visible-lg hidden-sm hidden-xs">
                                                                     <a class="btn btn-xs btn-blue tooltips"  target="_blank" href="<?php echo base_url(); ?>/index.php/school/studentAdmissionCardPdf/<?php echo $students['student_id'] ?>">
                                                                        Card
                                                                    </a>
...
<?php } else { ?>
                    toastr.success('Registered Students in the school');
<?php } ?>
            </script>
            </body>
            <!-- end: BODY -->
