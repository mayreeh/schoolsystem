								...
								<!-- start breadcrump -->
													<div class="breadcrumb flat" style="width: 100%;">
													       <a href="#" class="active" style="margin-left:4px;">Home</a>
															<a href="#" class="active"> Reportforms</a>
															<a href="#" ><?php $studentDetail = $this->load->main_model->getStudentById($student_id); echo $studentDetail[0]['firstname'] . '  ' . $studentDetail[0]['middlename'] . '  ' . $studentDetail[0]['lastname']?></a>
															 <a href="#"></a>
														</div>
									<!-- end breadcrump -->
							</div>
						 ...
						 <div class="modal-content" style="width: 50%; margin: auto;">
										<div class="modal-header"><h4 id="myLargeModalLabel" class="modal-title"> Select Category</h4></div>
											<div class="modal-body">
												<form role="form" class="form-horizontal" method="post" action = "<?php echo base_url();?>index.php/school/reportForm">
